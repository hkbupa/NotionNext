...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '19f1839d9108806eaf84f356d8def98a',
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2002, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HKBUPA', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Hong Kong Baptist University Postgraduate Association', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hkbupa.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'HKBUPA,Hong Kong Baptist University Postgraduate Association,香港浸會大學研究生會,浸大研會,hkbupa', // 网站关键词 英文逗号隔开
